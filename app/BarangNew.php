...
class BarangNew extends Model
{
	use Userstamps;
       ...
       protected $fillable = [ 'kode', 'tahun_anggaran', 'kode_barang', 'nama_barang', 'merk_type', 'tanggal_perolehan', 'rupiah_satuan', 'ruang', 'kondisi_barang', 'gambar', 'created_by', 'updated_by', 'deleted_by',        ];
