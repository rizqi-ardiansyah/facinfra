              ...
              <tr>
                <td>
                  <label for="">Nama Barang</label>
                      <select name="id[]" id="" class="myselect" style="width:200px">
