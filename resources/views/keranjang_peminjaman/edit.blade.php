        ...
        <form action="/keranjang_peminjaman/update" method="post">
            ...
            <div class="form-group">
                <label for="">Nama Barang</label>
                 ...
                 @foreach ($barang as $r)
                  @if ($peminjaman2->id_barang==$r->id)
                  <option value="{{$r->id}}" selected="selected">{{$r->nama_barang}}</option>
                  @else
            ...
            <div class="form-group">
                ...
                <input type="number" name="jumlah" class="form-control" value="{{$peminjaman2->jumlah_pinjam}}" required placeholder="Masukan Ruangan">
            </div>
            <div class="form-group">
